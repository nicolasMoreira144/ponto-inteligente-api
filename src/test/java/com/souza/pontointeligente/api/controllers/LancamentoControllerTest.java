...
import com.souza.pontointeligente.api.dtos.LancamentoDto;
import com.souza.pontointeligente.api.entities.Funcionario;
import com.souza.pontointeligente.api.entities.Lancamento;
import com.souza.pontointeligente.api.enums.TipoEnum;
import com.souza.pontointeligente.api.services.FuncionarioService;
import com.souza.pontointeligente.api.services.LancamentoService;
...
public class LancamentoControllerTest {
	...
	@Test
	@WithMockUser(username = "admin@admin.com", roles = {"ADMIN"}) // se não hover o perfil admin o teste ira falhar
	public void testRemoverLancamento() throws Exception {			// neste caso estamos simulando um usuario com username 'admin@admin.com' e perfil 'admin'  	
	...
	@Test
	@WithMockUser
	public void testRemoverLancamentoAcessoNegado() throws Exception { // aqui vai falhar apenas admin podem remover um lancamento  
		BDDMockito.given(this.lancamentoService.buscarPorId(Mockito.anyLong())).willReturn(Optional.of(new Lancamento()));
